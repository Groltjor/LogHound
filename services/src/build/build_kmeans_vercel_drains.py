...
MODEL_SERVICES = PROJECT_ROOT / 'models'

if str(SRC_SERVICES) not in sys.path:
    sys.path.insert(0, str(SRC_SERVICES))
...
folder_name = os.path.join(str(MODEL_SERVICES), 'kmeans')
