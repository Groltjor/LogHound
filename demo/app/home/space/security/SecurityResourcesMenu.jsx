  ...
  const rulesetEmptyCopy = useMemo(() => {
    if (rulesetReady) {
      return {
        ...
        body:
          "La primera regla simulada se agregará desde Target Lock usando el user agent seleccionado.",
      };
    }
    ...
    return {
      ...
      body:
        "Para crear reglas haz lock-in a un agente desde la vista granular. El RuleSet se conserva únicamente en este navegador.",
    };
  }, [rulesetReady]);
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-2 text-sm leading-6 text-white/64">
                        Simula una defensa global que desafiaría tráfico sospechoso antes de que llegue a la aplicación.
                        El estado se conserva únicamente en este navegador.
                      </p>

                      <div className="mt-4 rounded-md border border-white/10 bg-black/22 p-3 text-xs leading-5 text-white/55">
                        Modo demo: no se envían solicitudes a Vercel ni se modifica un firewall real.
                      </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-3 text-sm leading-6 text-white/64">
                    Esta acción simulará Attack Challenge Mode para mostrar el flujo completo del producto. No afectará
                    ningún proyecto, dominio o solicitud real.
                  </p>

                  <div className="mt-4 rounded-md border border-white/10 bg-black/26 p-3 text-xs leading-5 text-white/54">
                    El cambio se guardará en localStorage y desaparecerá al limpiar los datos del navegador.
                  </div>
