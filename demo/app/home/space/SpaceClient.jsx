...
const ENDPOINT = "/data/demo-predictions.json";
...
export default function SpaceClient() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-zinc-950 text-white">
      <div className="pointer-events-none fixed left-1/2 top-4 z-[140] -translate-x-1/2 rounded-full border border-emerald-300/30 bg-zinc-950/72 px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-emerald-100 shadow-2xl backdrop-blur-xl">
